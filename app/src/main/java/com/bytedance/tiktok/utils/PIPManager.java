...
import com.bytedance.tiktok.widget.FloatView;
import com.bytedance.tiktok.widget.controller.FloatController;
...
public class PIPManager {
    ...
    private PIPManager() {
        mVideoView = new VideoView(App.getInstance());
        VideoViewManager.instance().add(mVideoView, Tag.PIP);
        mFloatController = new FloatController(App.getInstance());
